...
public class Calendar1 {
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            // print the day and the day of week
            String dayName = dayOfWeekToDayName(dayOfWeek);
            System.out.println(dayOfMonth + "/" + month + "/" + year + " : " + dayName);// + ". nDaysInMonth:" + nDaysInMonth);
            //// If you want to stop the loop after n days, replace the condition of the
            //// if statement with the condition (debugDaysCounter == n)
            if (dayOfMonth==31 && month==12 && year==1999 || debugDaysCounter==420) {
                break;
            }
            debugDaysCounter++;
            advance();
